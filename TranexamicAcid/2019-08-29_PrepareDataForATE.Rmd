...
**Same as 2019-07-31_PrepareDataForATE.Rmd except for adding `HTIC`.**
...
selectedData$Delta.hemocue <- as.numeric(rawData$Hemocue.arrivee.hop) - as.numeric(rawData$Hemocue.init)
```
...
missing.data.reshaped <- data.table::melt(missing.data, id.var="variable.names")

ggplot2::ggplot(missing.data.reshaped, aes(x = reorder(variable.names, value), y = (100 * value / dims[1]), fill = variable)) + 
...
# Save the data
```{r save_data_for_ate}
write.csv(data_indAll, file="~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/Data/2019-08-29_data_preprocessed_all_individuals.csv")
write.csv(data_indTBI, file="~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/Data/2019-08-29_data_preprocessed_tbi_individuals.csv")
```
...
pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-08-29_mca_ind_before.pdf") 
plot(resMCA,invisible=c("var","quali.sup","quanti.sup"),cex=0.7)
dev.off()

pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-08-29_mca_var_before.pdf")
...
pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-08-29_mca_mixed_before.pdf")
...
ggsave("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-08-29_shock_hemocue_before.pdf", plot = last_plot())
```
...
pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-08-29_mca_ind_after.pdf") 
plot(resMCA,invisible=c("var","quali.sup","quanti.sup"),  cex=0.7)
dev.off()

pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-08-29_mca_var_after.pdf")
plot(resMCA,invisible=c("ind","quali.sup","quanti.sup"),
     selectMod = "contrib 9",
...
pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-08-29_mca_mixed_after.pdf")
plot(resMCA,invisible=c("quali.sup","quanti.sup"),cex=0.8)
dev.off()
...
ggsave("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-08-29_shock_hemocue_after.pdf", plot = last_plot())
