...
setwd("~/Documents/TraumaMatrix/TraumaMatrixPipeline/")
...
# 
# rawData <- rawData %>%
#             select(-c(colnames(rawData)[which(grepl("*..valeurs.manquantes", colnames(rawData)))]))
# 
# 
...
# Save the data
```{r save_data_for_ate}
write.csv(data_indAll, file="~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/Data/2019-10-23_data_preprocessed_all_individuals.csv")
write.csv(data_indTBI, file="~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/Data/2019-10-23_data_preprocessed_tbi_individuals.csv")
```
...
pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-10-23_mca_ind_before.pdf") 
plot(resMCA,invisible=c("var","quali.sup","quanti.sup"),cex=0.7)
dev.off()

pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-10-23_mca_var_before.pdf")
...
pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-10-23_mca_mixed_before.pdf")
...
ggsave("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-10-23_shock_hemocue_before.pdf", plot = last_plot())
```
...
pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-10-23_mca_ind_after.pdf") 
plot(resMCA,invisible=c("var","quali.sup","quanti.sup"),  cex=0.7)
dev.off()

pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-10-23_mca_var_after.pdf")
plot(resMCA,invisible=c("ind","quali.sup","quanti.sup"),
     selectMod = "contrib 9",
...
pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-10-23_mca_mixed_after.pdf")
plot(resMCA,invisible=c("quali.sup","quanti.sup"),cex=0.8)
dev.off()
...
ggsave("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-10-23_shock_hemocue_after.pdf", plot = last_plot())
