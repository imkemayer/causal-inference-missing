...
# Save the data
```{r save_data_for_ate}
write.csv(data_indAll, file="~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/Data/ate_analysis_traumabase_large_data_preprocessed_all_individuals.csv")
write.csv(data_indTBI, file="~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/Data/ate_analysis_traumabase_large_data_preprocessed_tbi_individuals.csv")
```
...
```{r}
library(yaml)
ais.classes <- read_yaml("~/Documents/TraumaMatrix/CausalInference/Simulations/causal-inference-missing/TranexamicAcid/LargeTraumabase/head_traumas_classification.yml")
...
write.csv(data_indTBI_AIS, file="~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/Data/ate_analysis_traumabase_large_data_preprocessed_tbi_individuals_ais.csv")
```