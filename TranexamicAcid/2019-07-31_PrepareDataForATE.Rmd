...
**Same as 2019-06-06_PrepareDataForATE.Rmd except for adding `Remplissage.total.cristalloides` and `Remplissage.total.colloides` as confounders.**
...
selectedData <- rawData[, c("Traitement.anticoagulant", "Traitement.antiagregants", 
                            ...
                            "Remplissage.total.cristalloides", "Remplissage.total.colloides")]
...
features_to_recode_2 <- c("PAS.min", "PAD.min",
                          ...
                          "Glasgow.sortie", "AIS.tete", "AIS.face", "AIS.thorax",	"AIS.abdo.pelvien", "AIS.membres.bassin",	"AIS.externe", "Glasgow.initial", "Glasgow.moteur.initial", "Alcool", "Remplissage.total.cristalloides", "Remplissage.total.colloides")
...
4) When there are missing values for any of these procedures done in the hospital, they are assumed not to have been done (as per the doctors' recommendation): `Catecholamines`, `KTV.poses.avant.TDM`, `Dose.NAD.depart`, `Osmotherapie`, `PIC`, `DVE`,  `Hypothermie.therapeutique`, `Craniectomie.decompressive`, `Acide.tranexamique`, `Bloc.J0.neurochirurgie`. Adding also `Remplissage.total.cristalloides` and `Remplissage.total.colloides`.
```{r}
...
features_to_recode_3 <- c("Catecholamines", "KTV.poses.avant.TDM", "Dose.NAD.depart", "Osmotherapie", "PIC", "DVE", "Hypothermie.therapeutique", "Craniectomie.decompressive", "Acide.tranexamique", "Bloc.J0.neurochirurgie","Remplissage.total.cristalloides","Remplissage.total.colloides")
...
treatments <- c("Mannitol.SSH", 
                ...
                "Acide.tranexamique",
                "Bloc.J0.neurochirurgie","Remplissage.total.cristalloides","Remplissage.total.colloides") 
...
# Save the data
```{r save_data_for_ate}
write.csv(data_indAll, file="~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/Data/2019-07-31_data_preprocessed_all_individuals.csv")
write.csv(data_indTBI, file="~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/Data/2019-07-31_data_preprocessed_tbi_individuals.csv")
```
...
pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-07-31_mca_ind_before.pdf") 
plot(resMCA,invisible=c("var","quali.sup","quanti.sup"),cex=0.7)
dev.off()

pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-07-31_mca_var_before.pdf")
...
pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-07-31_mca_mixed_before.pdf")
...
ggsave("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-07-31_shock_hemocue_before.pdf", plot = last_plot())
```
...
pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-07-31_mca_ind_after.pdf") 
plot(resMCA,invisible=c("var","quali.sup","quanti.sup"),  cex=0.7)
dev.off()

pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-07-31_mca_var_after.pdf")
plot(resMCA,invisible=c("ind","quali.sup","quanti.sup"),
     selectMod = "contrib 9",
...
pdf("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-07-31_mca_mixed_after.pdf")
plot(resMCA,invisible=c("quali.sup","quanti.sup"),cex=0.8)
dev.off()
...
ggsave("~/Documents/TraumaMatrix/CausalInference/AcideTranexamique/2019-07-31_shock_hemocue_after.pdf", plot = last_plot())
